...
public class CompensationController {
    ...
    public Compensation create(@RequestParam String employeeId, @RequestBody Compensation compensation) {
        LOG.debug("Received compensation create request for id [{}]", compensation.getCompensationId());
